...
/**
 * Mapeo bidireccional entre [com.uquiz.android.data.stats.entity.QuestionStatsEntity] y
 * [com.uquiz.android.domain.stats.model.QuestionStats].
 */
internal object QuestionStatsMapper {
    fun toEntity(model: QuestionStats): QuestionStatsEntity =
        QuestionStatsEntity(
            id = model.id,
            userId = model.userId,
    ...
    fun toModel(entity: QuestionStatsEntity): QuestionStats =
        QuestionStats(
            id = entity.id,
