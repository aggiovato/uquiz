...
import com.uquiz.android.core.user.UserDefaults
...
class UserProfileRepositoryImpl(
    ...
    override fun observeCurrent(): Flow<UserProfile> =
        currentUserRepository
            ...
            .flatMapLatest { userId ->
                userProfileDao
                    .observeById(userId ?: UserDefaults.LOCAL_DEFAULT_USER_ID)
                    .map { entity ->
    ...
    private suspend fun createDefaultProfile(): UserProfile {
        ...
        val profile =
            UserProfile(
                id = UserDefaults.LOCAL_DEFAULT_USER_ID,
                displayName = UserDefaults.LOCAL_DEFAULT_USER_NAME,
                avatarIcon = null,
                avatarImageUri = null,
                createdAt = now,
                updatedAt = now,
